...
public class WallSign2D extends AbstractSignType {
    public WallSign2D(){
        super();
        ...
        front.put(MaterialType.BEDS, new FullTransformation(
                new Vector3f(-0.14F,0.048F, 0.389F),
        ...
        front.put(MaterialType.SHIELD, new FullTransformation(
                new Vector3f(-0.14F,0.175F,0.389F),
        ...
        back.put(MaterialType.BEDS, new FullTransformation(
                new Vector3f(-0.14F,0.048F, -0.483F),
                new AxisAngle4f(1.572F, -1,0,0),
                new Vector3f(0.28F,0.001F,0.28F),
                new AxisAngle4f(1.572F, 0, 1, 0)));
        back.put(MaterialType.SHIELD, new FullTransformation(
